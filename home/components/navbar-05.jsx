                    ...
                    <div className="grid flex-1 gap-x-8 gap-y-6 py-4 pr-8 md:grid-cols-2 md:px-0 md:py-8 lg:py-8 lg:pr-8">
                      ...
                      <div className="grid auto-rows-max grid-cols-1 grid-rows-[max-content] gap-y-2 md:gap-y-4">
                        ...
                        >
                          ...
                          <div className="flex flex-col items-start justify-center">
                            <h5 className="font-semibold">Marketing Tips</h5>
                            <p className="hidden text-sm md:block">
                              Strategies to enhance your marketing efforts.
                            </p>
                          </div>
                        </a>
                        <a
                        ...
                        >
                          ...
                          <div className="flex flex-col items-start justify-center">
                            <h5 className="font-semibold">Automation Tools</h5>
                            <p className="hidden text-sm md:block">
                        ...
                        >
                          ...
                          <div className="flex flex-col items-start justify-center">
                            ...
                            <p className="hidden text-sm md:block">
                              Successful projects we've completed.
                            </p>
                          </div>
                        </a>
                        <a
                        ...
                        >
                          ...
                          <div className="flex flex-col items-start justify-center">
                            ...
                            <p className="hidden text-sm md:block">
                              Join our upcoming webinars for insights.
                            </p>
                          </div>
                        </a>
                      </div>
