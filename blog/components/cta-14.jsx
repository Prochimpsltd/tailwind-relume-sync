      ...
      <div className="container grid grid-rows-1 items-start gap-y-5 md:grid-cols-2 md:gap-x-12 md:gap-y-8 lg:gap-x-20 lg:gap-y-16">
        ...
        <div>
          <p className="md:text-md">
            Join our community to receive the latest insights and exclusive
            content straight to your inbox. Don't miss out on valuable updates
            that can elevate your marketing strategy.
          </p>
